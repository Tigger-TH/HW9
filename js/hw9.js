...
function showTimeGreeting(elementId) {
    ...
    if (hour < 12) {
        greeting = "สวัสดีตอนเช้าครับ ☀️ ยินดีต้อนรับสู่เว็บไซต์ของผม";
    } else if (hour < 18) {
        greeting = "สวัสดีตอนบ่ายครับ 🌤️ ยินดีต้อนรับสู่เว็บไซต์ของผม";
    } else {
        greeting = "สวัสดีตอนเย็นครับ 🌙 ยินดีต้อนรับสู่เว็บไซต์ของผม";
    }
